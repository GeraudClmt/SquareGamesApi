...
INSERT INTO player_model (id, uuid, game_id, token_name)
VALUES (1, 'd290f1ee-6c54-4b01-90e6-d701748f0851', 1, 'X');

INSERT INTO player_model (id, uuid, game_id, token_name)
VALUES (2, '2c6f7f7a-8e62-4a5d-9e9e-2f0ed2bdb6d8', 1, 'O');
...
INSERT INTO player_model (id, uuid, game_id, token_name)
VALUES (3, '6f1e1b3c-4c7a-4f7e-9e2b-1e5c5d5e3f2a', 2, 'X');

INSERT INTO player_model (id, uuid, game_id, token_name)
VALUES (4, '9e2c3d4b-5f6a-4b7d-8c9e-0f1a2b3c4d5e', 2, 'O');

-- ------------------------------
-- Insertion des tokens pour le premier jeu
-- ------------------------------

INSERT INTO board_token_model (id, player_id, x, y)
VALUES
    (1, 1, 0, 0),
    (2, 1, 1, 1),
    (3, 2, 0, 1),
